    ...
    if 'user_id' not in request.session:
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                try:
                    # Rechercher l'utilisateur par e-mail uniquement
        ...
        form = LoginForm()
        return render(request, template_name="accounts/login.html", context={"login_form": form, "msg": msg})
    else:
        return redirect("/")
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                user = Register.objects.create(
                    ...
                    profile_img=form.cleaned_data['image'],
                )
                user.is_active = True  # L'utilisateur est directement actif
                user.save()
                ...
                return redirect('/')  # Remplacez '/' par la page d'accueil ou une autre page de destination
            else:
